...
export default function SearchPopup(
  {setSelectedFoods, setModalOpen}
  :{setSelectedFoods: Function, setModalOpen: Function}) {
  ...
  return (
    <div>
      <div>
        <form>
          <input type="text" name="search" placeholder="Search foods..." onChange={(e)=> handleChange(e)}></input>
        </form>
      </div>
