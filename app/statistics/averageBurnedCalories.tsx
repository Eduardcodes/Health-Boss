...
export default function AverageBurnedCalories() {
  ...
  if(userData) {
    ...
    useEffect(()=>{
      const {calorieCount} = averageCaloriesBurnedPrevSessions(exerciseHistory,period)
  ...
  return (
    <div className="flex flex-col gap-2">
      <h6 className="mx-6 text-lg ">Your average calories burned over the last</h6>
